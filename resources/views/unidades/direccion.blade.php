                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="property-slider">
                        <div id="property-slider" class="owl-carousel owl-theme">
                            <div class="item">
                                <img src="{{ asset('assets/img/unidades/dir-img1.jpg') }}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('assets/img/unidades/dir-img2.jpg') }}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('assets/img/unidades/dir-img3.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
