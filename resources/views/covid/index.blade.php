...
<head>
  ...
  <meta http-equiv="Pragma" content="no-cache">
	...
	<link rel="stylesheet" href="{{asset('dist/mycvidcss.css')}}"></script>
	    <style>
    .cajaf{
      position: fixed;
      bottom: 60px;
...
<body >
    <div class="cajaf">
      ...
      <a class="caja1" href="{{route('covid.region')}}" alt="covid region" title="covid region">Por Region</a>
      
      <a class="caja2" href="{{route('covid.pais')}}" alt="covid pais" title="covid pais">Por Pais</a>
      
      <a class="caja3" target="_blank" href="https://sedespotosi.com" alt="sedes" title="sedes">SEDES Potosi</a>
    </div>
	<div class="head">
				...
				<ul class="tabs" role="tablist">
				    ...
				    <li>
				        ...
				        <label for="tab2"
				               ...
				               tabindex="0">Casos Diarios</label>
				        <div id="tab-content2" 
				             class="tab-content"
				             role="tabpanel" 
	...
	<script type="text/javascript" src="{{asset('dist/urlsrus.js')}}"></script>
	<script type="text/javascript" >
		var URI_ATCVN=URL_COVID[Number("{{$tipot}}")];
	</script>
	<script type="text/javascript" src="{{asset('dist/mycvidjs.js')}}"></script>	
