            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="about-conter">
                        <h3>Historia</h3>
                        <p>Las actividades de salud de Potosí se iniciaron en el año 1923 con la vigencia de la primera Sanidad Departamental, establecimiento ubicado en calle Linares esquina plaza 10 de Noviembre. Consectetur adipisicing elit. Dignissimos eos, consequuntur itaque harum, dicta dolorum sint consectetur doloremque ipsa repellat animi id voluptates, aperiam magni similique consequatur maxime vitae. Pariatur.</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum minus iste quasi, ut dolorum temporibus quas! Neque reprehenderit aperiam aspernatur perspiciatis voluptatum, quod dolorum dolore qui, quae vel odio! Necessitatibus.</p>
                    </div>
                </div>
            </div>
        </div>
