    ...
    <div id="page-banner-area" class="page-banner">
        <div class="page-banner-title">
            <div class="text-center">
                ...
                <a href="index.html"><i class="lni-home"></i> Inicio</a>
                ...
                <div class="container scroll">
                    <table class="table isSearch table-bordered table-hover" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Dr. Eddy Salguero Gomez&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Abg. Lourdes Quispe Navia</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Sria. Juana Coro Apaza</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">UNIDAD DE PLANIFICACION</td>
                            <td class="body-item mbr-fonts-style display-7">Area Informática</td>
                            <td class="body-item mbr-fonts-style display-7">Ing. Roger Choque Viscarra</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Pdta. Paola Ramos Quiroz</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Lic. Vania Argandoña Romero</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Abg. Karen Cardenas Ramirez</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Sr. Carlos Caruncho Ruiz</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Unidad de Redes de
                                Servicio Salud</td>
                            <td class="body-item mbr-fonts-style display-7">Dr. Eloy Tirado</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Dr. Vladimir Burgoa Valverde</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Lic. Daysi Calderon</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Dr. Huascar Alarcon Duran</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Lic. Rosario Delgado</td>
                        ...
                        <tr>
                            ...
                            <td class="body-item mbr-fonts-style display-7">Dra. Nelcy Bonifaz Rios</td>
